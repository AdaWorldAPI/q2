// BodyHelix2 — the V4-BAKE fork of BodyHelix, serving /helix2. A verbatim fork
// (like GeoHelix was forked from BodyHelix, and BodyHelix from BodyV3, #64) so
...
export default function BodyHelix2() {
  ...
  const title =
    ...
    : '/helix2 — living anatomy browser (v4 bake)';
  const subtitle = d
    ? scene
