...
import { useReplayMode, actorColor, fnv1aHex8 } from './useReplayMode';
import {
  getFileHandle,
  updateFileContent,
...
// Palette helpers — drift-mitigation tests pinning bit-for-bit parity
// with the Rust siblings in `crates/quarto-core/src/attribution/palette.rs`.
describe('palette helpers', () => {
  ...
  describe('fnv1aHex8', () => {
    it('matches Rust FNV-1a 32-bit reference vectors bit-for-bit', () => {
      ...
      // A divergence here is a producer/consumer drift bug.
